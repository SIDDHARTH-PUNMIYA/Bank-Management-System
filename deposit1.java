...
public class deposit1 extends JFrame implements ActionListener{
    ...
    deposit1(){
        ...
        int x = fm.stringWidth("Initialization");
        ...
        setTitle(pad+"Initialization");
        
        
        l1 = new JLabel("ENTER AMOUNT Rs 0 TO INITIATE");
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter the Amount Rs 0 to initiate your records");
                    ...
                    JOptionPane.showMessageDialog(null, "Your Current Balance is "+a);
